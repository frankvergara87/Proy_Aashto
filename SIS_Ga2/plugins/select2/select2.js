...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        triggerChange: function (details) {
            ...
            //if (document.getElementById("HDUIElementCodeAll").value != "") {
            //    var result = JSON.parse(document.getElementById("HDUIElementCodeAll").value);
            //    for (var x = 0; x < result.length; x++)
            //    {
            //        if (document.getElementById(result[x].ElementCode) != null) {
            //            document.getElementById(result[x].ElementCode).innerHTML = result[x].ElementCaptionText;
            //        }
            //    }
